...
- [docs/principles/tool-calling.md](docs/principles/tool-calling.md) — tool-call 원리 (형식 호환 vs 모델 역량)
- [docs/experiments/01-seoul-population-mcp.md](docs/experiments/01-seoul-population-mcp.md) — 서울 도시인구 MCP 분석: 8B의 환각 실패 사례
